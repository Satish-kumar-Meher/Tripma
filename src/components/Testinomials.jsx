...
const testimonials = [
    ...
    },
    {
        ...
        image: "https://randomuser.me/api/portraits/men/3.jpg",
        review: "Very Helpful",
        text: "This platform has helped me in learning new things.",
        rating: "⭐⭐⭐⭐",
    },
    {
        id: 4,
...
const TestimonialSlider = () => {
    return (
        <div className="relative bg-[#f0f9f8] py-10">

            {/* Label */}
            <Slide direction="up" duration={500} triggerOnce>
                <div className="relative mb-2 lg:mb-5 xl:mx-24 xl:w-[220px] lg:w-[200px] md:w-[180px] sm:w-[150px] w-[120px] flex items-center justify-center bg-white text-gray-800 lg:py-3 sm:py-2 py-1 rounded-full border-2 border-blue-300 shadow-lg">
                    <div className="absolute md:left-[15px] sm:left-[10px] left-[8px] flex">
                        <img
                            src="https://carento-demo.vercel.app/assets/imgs/page/homepage1/testimonial3.png"
                            alt="User1"
                    ...
                    <span className="xl:text-xl lg:text-lg md:text-base sm:text-xs text-[10px] font-bold lg:ml-15 sm:ml-13 ml-10">
                        Testimonials
                    </span>
                </div>
            </Slide>
            ...
            <Slide direction="up" duration={1000} triggerOnce>
                <div className="max-w-4xl lg:max-w-5xl xl:max-w-6xl mx-auto flex text-center">
                    <h2 className="text-2xl md:text-3xl font-bold lg:mb-10 mb-5 bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent">
                        What they say about us?
                    </h2>
                </div>
            </Slide>
                ...
                {testimonials.map((testimonial) => (
                    <SwiperSlide key={testimonial.id}>
                        <FadeContent 
                            ...
                            initialOpacity={0}
                        >
                            <div className="bg-white h-auto text-gray-800 p-6 rounded-xl shadow-xl hover:shadow-2xl transition-shadow duration-300 text-xs">
                                <h3 className="font-semibold sm:text-sm md:text-base lg:text-lg text-xs line-clamp-1 text-blue-600">
                                    {testimonial.review}
                                </h3>
                                <p className="lg:text-sm text-gray-600 sm:text-xs text-[10px] md:mt-2 sm:mt-1.5 mt-1 line-clamp-3">
                                    {testimonial.text}
                                </p>
                                <div className="flex items-center lg:gap-3 sm:gap-2 gap-1.5 sm:mt-4 mt-2">
                                    <img
                                        src={testimonial.image}
                                        alt={testimonial.name}
                                        className="lg:w-12 lg:h-12 sm:w-10 sm:h-10 h-7 w-7 rounded-full sm:border-2 border-[1px] border-gray-300"
                                    />
                                    <div>
                                        <h4 className="lg:text-lg font-bold sm:text-sm text-[11px] line-clamp-2">
                                            {testimonial.name}
                                        </h4>
                                        <p className="lg:text-base sm:text-xs text-[9px] text-gray-500 line-clamp-1">
                                            {testimonial.role}
                                        </p>
                                    </div>
                                    <span className="ml-auto lg:text-sm sm:text-xs text-[8px] text-yellow-500">
                                        {testimonial.rating}
                                    </span>
                                </div>
                            </div>
